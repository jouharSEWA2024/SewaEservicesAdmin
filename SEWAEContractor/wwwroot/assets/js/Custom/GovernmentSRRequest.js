...
function ValidateConsultant() {
    ...
    $.ajax({
        url: "https://"+base+"/Government/checkContractorConsultant?TradeLicense=" + TradeLicense + "&IssueAuthorityId=" + IssueAuthorityId,
        type: 'GET',
        contentType: false,
        processData: false,
        async:false,
...
function EnableTPValidation() {
    $('#TPTransactionIDValidationRequired').val(true);
    $('#TPTransactionTab').show();
}
function DisableTPValidation() {
    $('#TPTransactionIDValidationRequired').val(false);
